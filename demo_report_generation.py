    ...
    tools_demo = [
        ...
        },
        {
            ...
            "example_input": {
                ...
                "analysis_data": "Area: 45.7 hectares, NDVI average: 0.75, Image count: 342",
        ...
        },
        {
            ...
            "example_input": {
                "analysis_data": "NDVI values ranging 0.3-0.9, 342 images at 2.3cm/pixel resolution",
            ...
            "example_output": {
                ...
                "key_insights": ["High-quality dataset", "Variable crop health detected"],
                "ai_recommendations": ["Monitor low NDVI areas", "Consider targeted irrigation"]
            }
        }
    ]
    ...
    templates = [
        {
            ...
            "use_cases": ["NDVI monitoring", "Vegetation assessment", "Crop stress detection"]
        },
        {
            "id": "crop-health-detailed",
            "name": "Detailed Crop Health Report",
            "category": "Crop Health",
            "components": ["Executive Summary", "Drone Map", "Zone Analysis", "Detailed Charts", "Recommendations"],
            "use_cases": ["Precision agriculture", "Treatment planning", "Comprehensive monitoring"]
        },
        {
            "id": "volume-basic",
            "name": "Volume Measurement Report",
            "category": "Volume Analysis",
            "components": ["Executive Summary", "3D Visualization", "Volume Calculations", "Accuracy Metrics"],
            "use_cases": ["Stockpile measurement", "Material tracking", "Inventory management"]
        },
        {
            "id": "area-survey-basic",
            "name": "Area Survey Report",
            "category": "Land Survey",
            "components": ["Executive Summary", "Boundary Map", "Area Calculations", "Survey Results"],
            "use_cases": ["Land surveying", "Property mapping", "Boundary verification"]
        },
        {
            "id": "inspection-basic",
            "name": "Infrastructure Inspection",
            "category": "Inspection",
            "components": ["Executive Summary", "Defect Analysis", "Risk Assessment", "Maintenance Recommendations"],
            "use_cases": ["Infrastructure monitoring", "Safety assessment", "Maintenance planning"]
        },
        {
            "id": "environmental-basic",
            "name": "Environmental Monitoring",
            "category": "Environmental",
            "components": ["Executive Summary", "Environmental Data", "Impact Analysis", "Compliance Report"],
            "use_cases": ["Environmental monitoring", "Impact assessment", "Regulatory compliance"]
        }
    ]
