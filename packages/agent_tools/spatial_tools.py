...
def _calculate_geodesic_area(polygon_data: Dict[str, Any], crs: str = "EPSG:4326") -> float:
...
def _calculate_elevation_stats(polygon_data: Dict[str, Any], dsm_path: Path) -> Dict[str, float]:
