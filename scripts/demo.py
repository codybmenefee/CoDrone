#!/usr/bin/env python3
"""
Demo script for Canopy Copilot - Drone Data Analysis Assistant
"""
...
def get_tools() -> list:
    """Get tools with proper path setup."""
...
async def main() -> None:
    ...
    demo_queries = [
        ...
        (
            "Calculate the area for this field: "
            "[[40.7128, -74.0060], [40.7138, -74.0050], "
            "[40.7148, -74.0070], [40.7128, -74.0080]]"
        ),
