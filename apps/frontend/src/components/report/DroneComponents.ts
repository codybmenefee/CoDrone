...
export const createDroneComponents = (
  grapesjs: unknown,
...
export const droneComponentBlocks = [
  {
    ...
    media:
      '<div style="width:100%;height:50px;background:#f0f0f0;display:flex;align-items:center;justify-content:center;font-size:12px;">🗺️ Map</div>',
  },
  {
    id: 'analysis-chart',
    ...
    media:
      '<div style="width:100%;height:50px;background:#f0f0f0;display:flex;align-items:center;justify-content:center;font-size:12px;">📊 Chart</div>',
  },
  {
    ...
    media:
      '<div style="width:100%;height:50px;background:#f0f0f0;display:flex;align-items:center;justify-content:center;font-size:12px;">📋 Table</div>',
  },
  {
    ...
    media:
      '<div style="width:100%;height:50px;background:#f0f0f0;display:flex;align-items:center;justify-content:center;font-size:12px;">📄 Summary</div>',
  },
  {
    id: 'key-findings',
    label: 'Key Findings',
    ...
    media:
      '<div style="width:100%;height:50px;background:#f0f0f0;display:flex;align-items:center;justify-content:center;font-size:12px;">🔍 Findings</div>',
  },
];
